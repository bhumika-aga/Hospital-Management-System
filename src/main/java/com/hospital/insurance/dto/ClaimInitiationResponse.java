...
public class ClaimInitiationResponse {
    ...
    public ClaimInitiationResponse(Long claimId, String claimReferenceNumber, String patientName, String insurerName,
            Double treatmentCost, Double insuranceCoverage, Double balanceAmountToBePaid, String claimStatus,
            LocalDateTime claimInitiatedDate, LocalDateTime expectedDisbursementDate, String message) {
