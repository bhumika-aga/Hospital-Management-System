...
public class TreatmentPlanResponse {
    ...
    public static class PatientInfo {
        ...
        public PatientInfo(Long id, String name, Integer age, String ailment, String contactNumber, String email,
                String address) {
            this.id = id;
            this.name = name;
            this.age = age;
    ...
    public static class PackageInfo {
        ...
        public PackageInfo(String name, String specialization, List<String> tests, Double cost, Integer durationWeeks,
    ...
    public static class SpecialistInfo {
        ...
        public SpecialistInfo(String name, String level, String specialization, String contactNumber, String email,
