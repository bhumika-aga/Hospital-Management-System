...
('Amit Sharma', 'Knee joint pain and stiffness', 'Orthopaedics Package 1', 2500.0, 'Star Health Insurance', 'Orthopaedics Premium', 3500.0, 250.0, 'APPROVED', 'CLM-2024-10001', 1, CURRENT_TIMESTAMP - INTERVAL '10 days'),
('Priya Patel', 'Lower back pain and disc problems', 'Orthopaedics Package 2', 3000.0, 'HDFC ERGO Health', 'Ortho Care Plus', 2800.0, 200.0, 'PROCESSING', 'CLM-2024-10002', 2, CURRENT_TIMESTAMP - INTERVAL '15 days'),
('Rajesh Kumar', 'Kidney stones and urinary issues', 'Urology Package 1', 4000.0, 'ICICI Lombard Health', 'Urology Specialty', 4500.0, 0.0, 'INITIATED', 'CLM-2024-10003', 3, CURRENT_TIMESTAMP - INTERVAL '8 days'),
('Sunita Singh', 'Bladder infection and related complications', 'Urology Package 2', 5000.0, 'Max Bupa Health', 'Urology Complete Care', 5500.0, 0.0, 'APPROVED', 'CLM-2024-10004', 4, CURRENT_TIMESTAMP - INTERVAL '12 days');